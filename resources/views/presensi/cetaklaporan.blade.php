...
<body class="A4">
    ...
    <section class="sheet padding-10mm">
        ...
        <table style="width: 100%">
            <tr>
                <td style="width: 30px">
                    <img src="{{ asset('assets/img/logopmj.png') }}" width="100" height="100" alt="">
                </td>
                <td>
                    <span id="title">
                        LAPORAN PRESENSI KARYAWAN<br>
                        PERIODE {{ strtoupper($namabulan[$bulan]) }} {{ $tahun }}<br>
                        CV. PRAMANA MUKTI JAYA<br>
                    </span>
                    <span><i>Jl. Kalimulya Raya, Jl. H. Hamzah No.34, RT.004/RW.001, Pd. Rajeg, Kec. Cibinong, Kabupaten Bogor, Jawa Barat 16914</i></span>
                </td>
            </tr>
        </table>
